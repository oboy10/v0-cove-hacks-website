  ...
  return (
    <section id="about" className="relative py-20 md:py-28 bg-[#FAFAF7]">
      <div className="mx-auto max-w-5xl px-6">
        <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#1a1a1a]/45 mb-4">
          About
        </p>
        ...
        <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-3">
          {[
            ...
            >
              ...
              <p className="font-mono text-[10px] tracking-[0.2em] uppercase text-[#1a1a1a]/45 mt-1">
                {s.l}
              </p>
            </div>
          ))}
